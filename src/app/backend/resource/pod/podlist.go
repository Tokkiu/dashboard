...
func GetPodListByStatus(client k8sClient.Interface, heapsterClient client.HeapsterClient,
nsQuery *common.NamespaceQuery, pQuery *common.PaginationQuery,sQuery *common.NamespaceQuery) (*PodList, error) {
	log.Printf("Getting list of all pods in the cluster")

	channels := &common.ResourceChannels{
		PodList: common.GetPodListChannelWithOptionsByStatus(client, nsQuery,sQuery, api.ListOptions{}, 1),
	}
